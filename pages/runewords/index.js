...
export default function Misc({ runewords }) {
  let miniSearch;
              ...
              return <div key={item._id} className="col-lg-4">
                <div className="card mb-3">
                  <div className="card-body">
                    ...
                    {
                      item.runeList.map(runeItem => <span class="rune">{ runeItem.rune }</span>)
                    }
                    ...
                    <p>
                      {item.sockets} socket
                      {
                        item.itemsToInsertTo.map(itemsToInsertTo => <span class="item-to-insert-to">{itemsToInsertTo}</span>)
                      }
                    </p>
