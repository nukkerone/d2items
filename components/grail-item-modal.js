        ...
        { loaded &&
          <form onSubmit={(e) => save(e, category, item.slug)} id="grail-item-form">
            ...
            <div className="mb-3">
              ...
              <div className="form-check form-check-inline">
              <input className="form-check-input" type="radio" name="difficulty" id="hell" value="hell" checked />
            ...
            <div className="mb-3">
              <div className="form-check form-check-inline">
                <input className="form-check-input" type="radio" name="gameType" id="softcore" value="softcore" checked />
